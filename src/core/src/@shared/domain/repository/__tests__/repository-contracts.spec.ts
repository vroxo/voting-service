import { SearchParams, SearchResult } from '../../repository/repository-contracts';
...
describe("Search Unit Tests", () => {
  describe("SearchParams Unit Tests", () => {
    ...
    test('sort_dir prop', () => {
      ...
      arrange.forEach(i => {
        expect(
          new SearchParams({ sort: "field", sort_dir: i.sort_dir as any }).sort_dir).toBe(i.expected);
      });
    });
  ...
  describe('SearchResult Unit Tests', () => {
    ...
    it('should set last_page 1 when per_page field is greater then total field', () => {
    ...
    test('last__page prop when total is not a multiple of per_page', () => {
      const result = new SearchResult({
        items: [] as any,
        total: 101,
        current_page: 1,
